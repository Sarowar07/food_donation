...
const Landing = () => {
  return (
    <div className="-z-10 bg-black relative  text-white min-h-screen">
      
      <section className='relative  h-50vh flex flex-col justify-center items-start text-center '   >
        <img src="bread.jpg" className="absolute insect-0 w-full -z-1"/>
        <div className="flex flex-col items-center justify-center gap-10 ">

        <h1 className="text-5xl font-bold mb-4  mt-10">No One Should Go Hungry</h1>
        <p className=" text-xl text-start mb-3 max-w-xl ml-10">
          Every day, countless meals go uneaten on resturents while millions sleep hungry. Through our platform, restaurants share their surplus food, volunteers deliver it with compassion, and NGOs transform it into nourishment for those who need it most — creating a beautiful chain of giving that turns waste into hope.
        </p>
        

        <div className="flex space-x-4">
          <Link to="/create" className="px-6 py-3 mb-3 bg-white text-primary font-semibold rounded shadow hover:bg-gray-200 transition">
           Donate Food
          </Link>
          <Link to="/accept" className="px-6 py-3 mb-3 bg-white text-primary font-semibold rounded shadow hover:bg-gray-200 transition">
            Receive Help
          </Link>
        </div>
      </div>
      ...
      <section className="flex flex-wrap justify-center mt-12 gap-6 px-4 ">
        <Link to="/signin">
          <div className="bg-primary/80 h-60 w-60 p-5 rounded-lg shadow-lg hover:scale-105 transition-transform">
      ...
      <section className="mt-20 px-4 text-center bg-primary/70 h-60 py-10">
      ...
      <section className="mt-20 px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <div className="max-w-xs bg-primary/50 p-6 rounded shadow">
   ...
   <section className="">
    ...
    <div className="flex h-100 w-full ">
      <img src="photo1.jpg" className="flex-1 w-1/3 opacity-70 object-cover" />
  <img src="photo2.jpg" className="flex-1 w-1/3 opacity-70 object-cover" />
  <img src="photo3.jpg" className="flex-1 w-1/3 opacity-70 object-cover" />
    </div>
   </section>

      <footer className="mt-20 bg-primary/70  text-center py-6">
